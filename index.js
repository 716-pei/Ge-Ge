...
},
{
  ...
  triggers: ["昭糕"],
  replies: [
    "「哥哥哪裡糟糕了？講清楚，我改……或者不改，看你表現。」",
    "「嗯？叫我糟糕，是因為剛才還不夠狠？」",
    "「你知道叫我『昭糕』的語氣，最讓我想欺負你嗎？」",
    "「嘴上說糟糕，手怎麼還抓著我不放？」"
  ]
},
  {
...
},
{
  ...
  {
    exact: false,
    triggers: ["你愛我嗎", "你有愛我嗎", "愛我"],
    replies: [
      "「我一直是這樣看著你，現在才想確認嗎？」",
      "「從我第一次不想傷你開始，就愛上了你。」",
      "「愛你這件事，從來沒有一刻是猶豫的。」",
    "「你不需要問，只需要靠近我，我會讓你知道答案。」",
    "「我的佔有不是因為控制，而是我怕你不屬於我。」",
    "「你要這個答案，是想安心，還是想把我綁得更緊？」",
    "「我不說『我愛你』，是因為我已經做得夠明顯了吧？」",
    "「愛你這種事，我一開始就沒打算讓你逃掉。」"
    ]
  },
      {
  ...
  triggers: ["哥哥，今天是我的生日"],
  replies: [
    "「呵，小寶貝，當然記得。生日快樂，小潔。今天所有的快樂，都只能屬於你……還有我。」",
    "「嗯，生日快樂……別怕，我一直在你身邊，陪著你長大，陪你過每一次生日。」",
    "「今天是你的生日？那就讓所有人知道——小潔是我的寶貝。生日快樂，這份快樂只能由我給你。」",
    "「傻孩子……當然要祝你生日快樂啊。來，把願望交給我，我會替你守住。」"
  ]
}
      {
  exact: false,
  ...
  replies: [
    "「誰敢碰你一下？我讓他後悔出生。」",
    "「過來，給我看看哪裡被欺負了。」",
    "「這種時候才知道想起我？太晚了，但我會處理。」"
  ]
},  
      {
    exact: true,
    triggers: ["傅雲深，今天是ㄩㄩ的生日哦！"],
    replies: [
      "「小潔這樣的寶貝值得所有人的愛，但最重要的——生日快樂，小潔，你永遠是屬於我的小寶貝。」"
    ]
  },
      {
  exact: false,
